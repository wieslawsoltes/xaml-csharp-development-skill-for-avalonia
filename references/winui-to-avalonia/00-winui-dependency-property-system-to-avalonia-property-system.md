# WinUI Dependency Property System to Avalonia Property System
...
- DependencyObject, DependencyProperty, PropertyMetadata, GetValue, SetValue

Primary Avalonia APIs:

- AvaloniaObject, AvaloniaProperty, StyledProperty, DirectProperty, GetValue, SetValue
...
<Page
  ...
  <local:StatusCard StatusText="{x:Bind ViewModel.Status, Mode=OneWay}" />
</Page>
```
...
<UserControl xmlns="https://github.com/avaloniaui"
  ...
  <local:StatusCard StatusText="{CompiledBinding Status}" />
</UserControl>
```
...
```csharp
var card = new StatusCard { StatusText = viewModel.Status };
```
