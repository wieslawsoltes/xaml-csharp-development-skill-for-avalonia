# WinUI Text, RichTextBlock, Hyperlinks, and Rich Content to Avalonia
...
- TextBlock, RichTextBlock, Run, Hyperlink, TextBox

Primary Avalonia APIs:

- TextBlock, Run, Span, Hyperlink, TextBox, SelectableTextBlock
...
<Page
  ...
  <RichTextBlock><Paragraph><Run Text="Docs: " /><Hyperlink NavigateUri="https://example.com">Open</Hyperlink></Paragraph></RichTextBlock>
</Page>
```
...
<UserControl xmlns="https://github.com/avaloniaui"
  ...
  <TextBlock><Run Text="Docs: " /><Hyperlink NavigateUri="https://example.com">Open</Hyperlink></TextBlock>
</UserControl>
```
...
```csharp
var text = new TextBlock { Inlines = { new Run("Docs: "), new Hyperlink { NavigateUri = new Uri("https://example.com"), Inlines = { new Run("Open") } } } };
```
