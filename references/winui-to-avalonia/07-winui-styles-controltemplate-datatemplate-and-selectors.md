# WinUI Styles, ControlTemplate, DataTemplate, and Selectors to Avalonia
...
- Style, Setter, ControlTemplate, DataTemplate, DataTemplateSelector

Primary Avalonia APIs:

- Style, Setter, ControlTheme, ControlTemplate, DataTemplate, IDataTemplate
...
```csharp
var list = new ListBox { ItemTemplate = personTemplate };
```
