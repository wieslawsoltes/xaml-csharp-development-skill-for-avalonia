# WinUI Validation and Data Error Patterns to Avalonia
...
- INotifyDataErrorInfo, IDataErrorInfo, TextBox validation visuals

Primary Avalonia APIs:

- INotifyDataErrorInfo, DataValidationErrors, BindingNotification
...
```csharp
var emailBox = new TextBox(); emailBox.Bind(TextBox.TextProperty, new Binding("Email") { Mode = BindingMode.TwoWay });
```
