# WinUI Items Controls (ListView/GridView/ItemsRepeater/TreeView) to Avalonia
...
- ListView, GridView, ItemsRepeater, TreeView, ItemTemplate

Primary Avalonia APIs:

- ListBox, ItemsRepeater-equivalent patterns, TreeView, ItemsControl
...
<Page
  ...
  <TreeView ItemsSource="{x:Bind ViewModel.Nodes}" />
</Page>
```
