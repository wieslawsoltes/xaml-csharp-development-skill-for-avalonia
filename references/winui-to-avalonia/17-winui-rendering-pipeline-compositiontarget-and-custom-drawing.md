# WinUI Rendering Pipeline and CompositionTarget to Avalonia Rendering
...
- CompositionTarget.Rendering, SpriteVisual/Compositor, Win2D hosting

Primary Avalonia APIs:

- Render(DrawingContext), InvalidateVisual, Compositor/Custom visuals
