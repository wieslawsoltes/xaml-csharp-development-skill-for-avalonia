# WinUI Theming, High Contrast, and RequestedTheme Variants to Avalonia
...
- RequestedTheme, ApplicationTheme, HighContrastAdjustment

Primary Avalonia APIs:

- ThemeVariant, FluentTheme, theme resources, high contrast selectors
