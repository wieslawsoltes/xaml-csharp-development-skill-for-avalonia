# WinUI CollectionViewSource Grouping and ItemSource Patterns to Avalonia
...
- CollectionViewSource, IObservableVector, IncrementalLoadingCollection

Primary Avalonia APIs:

- CollectionView, ItemsSource, CollectionViewSource-like VM shaping
...
<Page
  ...
  <ListView ItemsSource="{x:Bind ViewModel.GroupedItems.View}" />
</Page>
```
...
<UserControl xmlns="https://github.com/avaloniaui"
  ...
  <ListBox ItemsSource="{CompiledBinding GroupedItems}" />
</UserControl>
```
...
```csharp
var list = new ListBox { ItemsSource = viewModel.GroupedItems };
```
