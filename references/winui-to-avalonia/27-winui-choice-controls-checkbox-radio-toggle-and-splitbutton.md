# WinUI Choice Controls (CheckBox/RadioButton/ToggleSwitch/SplitButton) to Avalonia
...
- CheckBox, RadioButton, ToggleSwitch, SplitButton

Primary Avalonia APIs:

- CheckBox, RadioButton, ToggleSwitch, SplitButton, ToggleButton
...
<UserControl xmlns="https://github.com/avaloniaui"
  ...
  <ToggleSwitch IsChecked="{CompiledBinding Enabled, Mode=TwoWay}" />
</UserControl>
```
...
```csharp
var toggle = new ToggleSwitch { IsChecked = viewModel.Enabled };
```
