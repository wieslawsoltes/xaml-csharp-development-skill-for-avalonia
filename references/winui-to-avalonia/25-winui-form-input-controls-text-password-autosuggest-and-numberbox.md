# WinUI Form Inputs (TextBox, PasswordBox, AutoSuggestBox, NumberBox) to Avalonia
...
- TextBox, PasswordBox, AutoSuggestBox, NumberBox

Primary Avalonia APIs:

- TextBox, AutoCompleteBox, NumericUpDown, MaskedTextBox
...
<UserControl xmlns="https://github.com/avaloniaui"
  ...
  <AutoCompleteBox Text="{CompiledBinding Query, Mode=TwoWay}" />
</UserControl>
```
...
```csharp
var suggest = new AutoCompleteBox { Text = viewModel.Query };
```
