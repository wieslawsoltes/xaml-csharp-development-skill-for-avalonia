# WinUI NavigationView + Frame/Page Shell to Avalonia Navigation Patterns
...
- NavigationView, Frame, Page, NavigationCacheMode

Primary Avalonia APIs:

- SplitView, TabControl, ContentControl routing, view-model navigation
...
```csharp
var shell = new SplitView { IsPaneOpen = true };
```
